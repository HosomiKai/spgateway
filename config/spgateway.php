...
return [
    ...
    */
    ...
    'VACC' => env('SPGATEWAY_VACC', 1), //Int(1)
    'CVS' => env('SPGATEWAY_CVS', 0), //Int(1)
    'BARCODE' => env('SPGATEWAY_BARCODE', 0), //Int(1)
    'P2G' => env('SPGATEWAY_P2G', 0), //Pay2go 電子錢 包啟用
    'CVSCOM' => env('SPGATEWAY_CVSCOM', 0), //啟用 使用前,須先登入智付通會員專區啟用物 流並設定退貨門市與取貨人相關資訊。1'=>超商取貨不付款  2'=>超商取貨付款  3'=>超商取貨不付款及超商取貨付款 0 或者未有此參數,即代表不開啟。 2.當該筆訂單金額小於 30 元或大於 2 萬元 時,即使此參數設定為啟用,MPG 付款頁 面仍不會顯示此支付方式選項。
];
